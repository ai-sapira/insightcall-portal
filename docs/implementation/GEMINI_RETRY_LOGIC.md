...
Si el modelo principal (`gemini-2.5-flash`) falla después de todos los reintentos, el sistema intenta automáticamente con modelos alternativos:

1. `gemini-2.0-flash-exp` (experimental)
2. `gemini-1.5-flash` (más estable)
3. `gemini-1.5-pro` (más potente pero más lento)
